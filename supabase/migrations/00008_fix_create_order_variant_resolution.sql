-- ============================================================
-- HAMMAH — Fix create_order variant resolution (55000 bug)
-- ============================================================
-- Problem: v_variant declared as RECORD is never assigned when
-- p_variant_value is NULL, but line 218 still dereferences
-- v_variant.size_label in COALESCE(), causing PostgreSQL 55000:
--   record "v_variant" is not assigned yet
--
-- Fix: Replace generic RECORD with explicitly initialised scalar
-- variables. Only populate when a variant is actually supplied.
-- ============================================================
